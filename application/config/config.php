...
if (isset($_SERVER['HTTP_HOST'])) {
	...
	$front_root = realpath(FCPATH);
	$script_path = '';

	if ($document_root && $front_root && strpos($front_root, $document_root) === 0) {
		$script_path = str_replace('\\', '/', substr($front_root, strlen($document_root)));
	} else {
		$script_path = rtrim(str_replace('\\', '/', dirname($_SERVER['SCRIPT_NAME'])), '/');
	}

	$config['base_url'] = $protocol.'://'.$_SERVER['HTTP_HOST'].$script_path.'/';
} else {
	$config['base_url'] = 'http://localhost/upy/';
}
...
|
*/
$config['encryption_key'] = 'webdev-ci3-secret-key-32-chars!!';
